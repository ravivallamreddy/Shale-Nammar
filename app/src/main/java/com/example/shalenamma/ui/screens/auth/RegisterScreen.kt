        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Text("Email Address", fontWeight = FontWeight.Bold, fontSize = 14.sp, color = MaterialTheme.colorScheme.onSurface)
                    Spacer(modifier = Modifier.height(8.dp))
                    OutlinedTextField(
                        value = email,
                    ...
                    Button(
                        onClick = { 
                            if (username.isNotEmpty() && email.isNotEmpty() && password.isNotEmpty()) {
                                // 📝 Explicitly save role as "Admin" or "Parent"
                                val finalRole = if (userRole == UserRole.ADMIN) "Admin" else "Parent"
                                authVM.signup(
                                    email = email,
                                    password = password,
                    ...
                    OutlinedButton(
                        onClick = { 
                            authVM.error = "Google Sign-In is not implemented yet. Please use email registration."
                        },
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(56.dp),
                    ...
                    Row(
                        ...
                        Text("Already have an account? ", color = MaterialTheme.colorScheme.onSurface.copy(alpha = 0.6f), fontSize = 12.sp)
                        Text(
                            "Login here",
